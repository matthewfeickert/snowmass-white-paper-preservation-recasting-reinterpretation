...
Additionally, FuncADL~\cite{Proffitt:2021wfh} constructs hierarchical data queries using SQL-like concepts in Python and has been used to explore applications of functional programming and query languages for LHC experiments.
